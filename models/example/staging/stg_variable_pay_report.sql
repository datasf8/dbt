...
{% set results =cmp_tables_cnt_chk('VARIABLE_PAY_DETAILED_BS2024') %}
select
    user_id,
    person_id_external,
...
from {{ source("landing_tables_CMP", "VARIABLE_PAY_REPORT") }}
union
select
    user_id,
    person_id_external,
    ...
    all_players_status,
    null as comp_plan_owner
from {{ source("landing_tables_CMP", "VARIABLE_PAY_DETAILED_BS2023") }}
union
select
    "User ID" AS user_id,
    ...
    "Individual Rating" AS individual_rating,
    ...
    "Gender" AS gender,
    "Currency Conversion Rate"::number(38,2) AS currency_conversion_rate,
    "Target Amount"::number(38,2) AS target_amount,
    "Start Date" AS start_date,
    "End Date" AS end_date,
    "All Player Status" AS all_players_status,
    "VarPay Manager Form Owner" AS comp_plan_owner
from {{ source("landing_tables_CMP", "VARIABLE_PAY_DETAILED_BS2024") }}
