...
with
    picklistdata as (
        ...
        inner join
            ...
            and i.id = 'OA_bonusweight'
    )
select
    optionId as bonus_weighting_id,
    externalcode as bonus_weighting_code,
    effectivestartdate as bonus_weighting_start_date,
    effectiveenddate as bonus_weighting_end_date,
    label_defaultvalue as bonus_weighting_name_en,
    label_fr_fr as bonus_weighting_name_fr,
    status as bonus_weighting_status
from picklistdata
