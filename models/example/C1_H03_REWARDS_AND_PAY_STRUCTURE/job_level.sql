...
select
    optionId as job_level_id,
    externalcode as job_level_code,
    effectivestartdate as job_level_start_date,
    effectiveenddate as job_level_end_date,
    label_defaultvalue as job_level_name_en,
    label_fr_fr as job_level_name_fr,
    status as job_level_status
from picklistdata
