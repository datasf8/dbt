...
select
    optionId as suffix_id,
    externalcode as suffix_code,
    effectivestartdate as suffix_start_date,
    effectiveenddate as suffix_end_date,
    label_defaultvalue as suffix_name_en,
    label_fr_fr as suffix_name_fr,
    status as suffix_status
from picklistdata
