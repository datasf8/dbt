...
with
    picklistdata as (
        ...
        inner join
            ...
            and i.id = 'OA_USA_RACE1'
    )
select
    optionid as race_id,
    externalcode as race_code,
    effectivestartdate as race_start_date,
    effectiveenddate as race_end_date,
    label_defaultvalue as race_name_en,
    label_fr_fr as race_name_fr,
