...
with
    picklistdata as (
        ...
        inner join
            ...
            and i.id = 'OA_challengestatus'
    )
select
    optionId as disability_status_id,
    externalcode as disability_status_code,
    effectivestartdate as disability_status_start_date,
    effectiveenddate as disability_status_end_date,
    label_defaultvalue as disability_status_name_en,
    label_fr_fr as disability_status_name_fr,
    status as disability_status_status
from picklistdata
