...
with
    picklistdata as (
        ...
        inner join
            ...
            and i.id = 'ecPhoneType'
    )
select
    optionId as phone_type_id,
    externalcode as phone_type_code,
    effectivestartdate as phone_type_start_date,
    effectiveenddate as phone_type_end_date,
    label_defaultvalue as phone_type_name_en,
    label_fr_fr as phone_type_name_fr,
    status as phone_type_status
from picklistdata
