...
select
    optionId as salutation_id,
    externalcode as salutation_code,
    effectivestartdate as salutation_start_date,
    effectiveenddate as salutation_end_date,
    label_defaultvalue as salutation_name_en,
    label_fr_fr as salutation_name_fr,
    status as salutation_status
from picklistdata
