...
with
    picklistdata as (
        ...
        inner join
            ...
            and i.id = 'ecMaritalStatus'
    )
select
    optionId as marital_status_id,
    externalcode as marital_status_code,
    effectivestartdate as marital_status_start_date,
    effectiveenddate as marital_status_end_date,
    label_defaultvalue as marital_status_name_en,
    label_fr_fr as marital_status_name_fr,
    status as marital_status_status
from picklistdata
