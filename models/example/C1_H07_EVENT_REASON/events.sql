...
select
    optionId as events_id,
    externalcode as events_code,
    effectivestartdate as events_start_date,
    effectiveenddate as events_end_date,
    label_defaultvalue as events_name_en,
    label_fr_fr as events_name_fr,
