...
with
    picklistdata as (
        ...
        inner join
            ...
            and i.id = 'ISOCountryList'
    )
select
    optionid as iso_country_id,
    externalcode as iso_country_code,
    effectivestartdate as iso_country_start_date,
    effectiveenddate as iso_country_end_date,
    label_defaultvalue as iso_country_name_en,
    label_fr_fr as iso_country_name_fr,
    status as iso_country_status
from picklistdata
