...
select
    optionid as degree_type_id,
    externalcode as degree_type_code,
    effectivestartdate as degree_type_start_date,
    effectiveenddate as degree_type_end_date,
    label_defaultvalue as degree_type_name_en,
    label_fr_fr as degree_type_name_fr,
    status as degree_type_status
from picklistdata
