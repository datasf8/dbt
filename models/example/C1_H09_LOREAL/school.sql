...
select
    optionid as school_id,
    externalcode as school_code,
    effectivestartdate as school_start_date,
    effectiveenddate as school_end_date,
    label_defaultvalue as school_name_en,
    label_fr_fr as school_name_fr,
