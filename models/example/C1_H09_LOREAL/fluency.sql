...
select
    optionid as fluency_id,
    externalcode as fluency_code,
    effectivestartdate as fluency_start_date,
    effectiveenddate as fluency_end_date,
    label_defaultvalue as fluency_name_en,
    label_fr_fr as fluency_name_fr,
    status as fluency_status
from picklistdata
