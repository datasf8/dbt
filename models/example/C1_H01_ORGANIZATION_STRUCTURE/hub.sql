...
select
    optionId as hub_id,
    externalcode as hub_code,
    effectivestartdate as hub_start_date,
    effectiveenddate as hub_end_date,
    label_defaultvalue as hub_name_en,
    label_fr_fr as hub_name_fr,
