...
with
    picklistdata as (
        ...
        inner join
            ...
            and i.id = 'ChangeReason'
    )
select
    externalcode as position_change_reason_code,
    effectivestartdate as position_change_reason_start_date,
    effectiveenddate as position_change_reason_end_date,
    label_defaultvalue as position_change_reason_name_en,
    label_fr_fr as position_change_reason_name_fr,
    status as position_change_reason_status
from picklistdata
