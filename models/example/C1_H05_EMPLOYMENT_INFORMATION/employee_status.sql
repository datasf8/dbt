...
with
    picklistdata as (
        ...
        inner join
            ...
            and i.id = 'employee-status'
    )
select
    optionId as employee_status_id,
    externalcode as employee_status_code,
    effectivestartdate as employee_status_start_date,
    effectiveenddate as employee_status_end_date,
    label_defaultvalue as employee_status_name_en,
    label_fr_fr as employee_status_name_fr,
    status as employee_status_status
from picklistdata
