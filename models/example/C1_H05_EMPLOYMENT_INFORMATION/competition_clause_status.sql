...
with
    picklistdata as (
        ...
        inner join
            ...
            and i.id = 'OA_yesNoPendingLegalDecision'
    )
select
    optionId as competition_clause_status_id,
    externalcode as competition_clause_status_code,
    effectivestartdate as competition_clause_status_start_date,
    effectiveenddate as competition_clause_status_end_date,
    label_defaultvalue as competition_clause_status_name_en,
    label_fr_fr as competition_clause_status_name_fr,
    status as competition_clause_status_status
from picklistdata
