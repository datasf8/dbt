...
with
    picklistdata as (
        ...
        inner join
            ...
            and i.id = 'global_assignment_type'
    )
select
    optionid as global_assignment_type_id,
    externalcode as global_assignment_type_code,
    effectivestartdate as global_assignment_type_start_date,
    effectiveenddate as global_assignment_type_end_date,
    label_defaultvalue as global_assignment_type_name_en,
    label_fr_fr as global_assignment_type_name_fr,
    status as global_assignment_type_status
from picklistdata
