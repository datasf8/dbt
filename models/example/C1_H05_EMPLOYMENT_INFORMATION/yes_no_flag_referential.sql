...
select
    optionid as yes_no_flag_referential_id,
    externalcode as yes_no_flag_referential_code,
    effectivestartdate as yes_no_flag_referential_start_date,
    effectiveenddate as yes_no_flag_referential_end_date,
    label_defaultvalue as yes_no_flag_referential_name_en,
    label_fr_fr as yes_no_flag_referential_name_fr,
    status as yes_no_flag_referential_status
from picklistdata
