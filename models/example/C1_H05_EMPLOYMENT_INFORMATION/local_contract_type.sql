...
with
    picklistdata as (
        ...
        inner join
            ...
            and i.id = 'contract-type'
    )
select
    optionId as local_contract_type_id,
    externalcode as local_contract_type_code,
    effectivestartdate as local_contract_type_start_date,
    effectiveenddate as local_contract_type_end_date,
    label_defaultvalue as local_contract_type_name_en,
    label_fr_fr as local_contract_type_name_fr,
    status as local_contract_type_status
from picklistdata
