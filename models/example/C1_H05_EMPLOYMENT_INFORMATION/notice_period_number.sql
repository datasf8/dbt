...
with
    picklistdata as (
        ...
        inner join
            ...
            and i.id = 'OA_noticeperiodnumber'
    )
select
    optionId as notice_period_number_id,
    externalcode as notice_period_number_code,
    effectivestartdate as notice_period_number_start_date,
    effectiveenddate as notice_period_number_end_date,
    label_defaultvalue as notice_period_number_name_en,
    label_fr_fr as notice_period_number_name_fr,
    status as notice_period_number_status
from picklistdata
