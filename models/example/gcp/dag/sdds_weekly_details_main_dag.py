...
import logging
from sdds_weekly_details_config import dag_config
...
TRUNCATE_QUERIES = dag_config.TRUNCATE_QUERIES
...
try:
    ...
    task = get_dag_details(dag, JOB_DETAILS, DAG_DETAILS, DESTINATION_PATH, TRUNCATE_QUERIES)
