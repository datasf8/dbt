...
from pmg_emp_goals_sftp_config.airflow_conn import airflow_connections
from pmg_emp_goals_sftp_config.dag_config import LMS_SCP_SECRET, LMS_SCP_CONN, FILE_DETAILS, \
...
def get_file_patterns():
    ...
    file_patterns = []
    file_patterns.append(env_name + "_" + today_date)
