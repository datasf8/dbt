...
from pmg_emp_profile_config import dag_config as config
...
# api_call_data >> api_to_gcs_python >> execute_snowflake_query >> load_to_dbt_cloud >> update_snowflake_audit
