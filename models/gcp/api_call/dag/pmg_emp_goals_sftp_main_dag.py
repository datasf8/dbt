...
from pmg_emp_goals_sftp_config.utils import *
from pmg_emp_goals_sftp_config.get_sftp_files import SFTPSensor
from pmg_emp_goals_sftp_config.snowflake_operator import call_snowflake_operator, snowflake_truncate_table
from pmg_emp_goals_sftp_config.encryption_decryption_operator import EncryptionOperator
from pmg_emp_goals_sftp_config.dag_config import LMS_SCP_CONN
...
try:
    with DAG(
            ...
            description="DAG for copy data from sftp server for pmgm employee goals activity",
            tags=['pmgm'],
