...
import logging
from pmg_emp_dev_goals_sftp_config.dag_config import SNOWFLAKE_STAGE_NAME, LMS_SNOWFLAKE_CONN
...
def call_snowflake_operator(bucket_name, parent_folder, files_to_be_copy, file_name,):
    ...
    for i, file in enumerate(files_to_be_copy):
        ...
        file_location = f"{snowflake_stage_name}/{parent_folder}/{file_name}"
        queries = [
