...
with
    connect_activities as (
        select distinct
            ...
            activity_status as dcac_activity_status_dcac,
            activity_creation_date as dcac_activity_creation_date_dcac,
            activity_last_modification_date as dcac_activity_last_modification_date_dcac
...
select
    hash(dcac_activity_id_dcac) as ddcac_activity_sk_ddcac,
