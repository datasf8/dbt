select distinct
    ddcac_activity_sk_ddcac as activity_id,
    dcac_activity_id_dcac as activity_id_v1,
    dcac_activity_key_dcac as activity_key,
...
from {{ ref("dim_dev_connect_activities") }}
