{% macro stry0398826_dim_param_ranges() %}
    ...
    {% set qRestAll %}
        ...
        insert into HRDP_SDDS_{{ env_var('DBT_REGION') }}_DB.BTDP_DS_C1_H05_EMPLOYMENT_INFORMATION_EU_{{ env_var('DBT_REGION') }}_PRIVATE.DIM_PARAM_RANGES values('GASSEN',48,60,1,0,'48 to 60 Months');
        insert into HRDP_SDDS_{{ env_var('DBT_REGION') }}_DB.BTDP_DS_C1_H05_EMPLOYMENT_INFORMATION_EU_{{ env_var('DBT_REGION') }}_PRIVATE.DIM_PARAM_RANGES values('GASSEN',60,9999999,1,0,'>=60 Months');
