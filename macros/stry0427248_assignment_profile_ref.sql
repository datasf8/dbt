{% macro stry0427248_assignment_profile_ref() %}
    ...
    {% set qRestAll %}
        ...
        insert into HRDP_SDDS_{{ env_var('DBT_REGION') }}_DB.BTDP_DS_C1_H08_LEARNING_EU_{{ env_var('DBT_REGION') }}_PRIVATE.DIM_PARAM_ASSIGNMENT_PROFILE_REFERENTIAL values
            ...
            (	'AP_BUSINESSMUST_DATA4ALL_STEP_2_TARGET',	'Data4All - Step 1',	'MUST',	'BUSINESSMUST',	'Business Must'	),
            ...
            (	'AP_BUSINESSMUST_SRA_MAKEUPTTT_TARGET',	'SRA - Makeup Fundamentals TTT and Certification - Luxe - Essential',	'MUST',	'BUSINESSMUST',	'Business Must'	),
            ...
            (	'AP_JBMUST_DIGITAL_APP_TARGET',	'Digital app',	'MUST',	'JBMUST',	'Job Must'	),
            ...
            (	'AP_JBMUST_IP_RIGHTS_TARGET',	'IP Rights',	'MUST',	'JBMUST',	'Job Must'	),
            ...
            (	'AP_JBMUST_MINERAL_KPI7',	'Mineral abudant KPI7',	'MUST',	'JBMUST',	'Job Must'	),
            ...
            (	'AP_JBMUST_SRA_RSM_TTT_LUXE_ADVANCED_TARGET',	'SRA - RSM (Retail Store Management) TTT and Certification - Luxe - Advanced',	'MUST',	'JBMUST',	'Job Must'	),
            (	'AP_JBMUST_SRAEMPATHY_LUXETTT_TARGET',	'SRA Empathy Luxe TTT',	'MUST',	'JBMUST',	'Job Must'	),
            ...
            (	'AP_ONBMUST_HR_FIT_EXECUTIVE_TARGET',	'HR FIT Executive',	'MUST',	'ONBMUST',	'Onboarding Must'	),
