{% macro stry0444292_rbac_tables() %}
    ...
    {% set qRestAll %}
        ...
        create or replace table database_table 
            (database_name varchar,owner_role varchar
            , created_by varchar default current_user, created_at timestamp default current_timestamp
            , updated_by varchar default current_user, updated_at timestamp default current_timestamp);
